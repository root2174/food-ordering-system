		...
		try {
			...
			kafkaProducer.send(
					...
					orderKafkaMessageHelper.getKafkaCallback(
							KafkaCallbackArgs.<PaymentRequestAvroModel>builder()
									.responseTopicName(orderServiceConfigData.getPaymentResponseTopicName())
									.orderId(orderId)
									.avroModel(paymentRequestAvroModel)
									.requestAvroModelName(PaymentRequestAvroModel.class.getSimpleName())
									.build()
					));

...
public class OrderDataAccessMapper {
	...
	public OrderEntity orderToOrderEntity(Order order) {
		OrderEntity orderEntity = OrderEntity.builder()
				...
				.items(orderItemsToOrderItemsEntities(order))
	...
	public Order orderEntityToOrder(OrderEntity orderEntity) {
		ArrayList<String> failureMessages = orderEntity.getFailureMessages().isEmpty() ? new ArrayList<>() :
	...
	private List<OrderItemEntity> orderItemsToOrderItemsEntities(Order order) {
